...
RESOLVER_BASE        = env("VC_RESOLVER_ORIGIN", cfg_get("resolver","base","http://127.0.0.1:8094"))
SLATE_URL            = env("VC_SLATE_URL",       cfg_get("resolver","slate_url",""))
PLACEHOLDER_TITLE    = env("VC_PLACEHOLDER_TITLE",    cfg_get("placeholders","title","Stand By"))
PLACEHOLDER_SUBTITLE = env("VC_PLACEHOLDER_SUBTITLE", cfg_get("placeholders","subtitle",""))
PLACEHOLDER_SUMMARY  = env("VC_PLACEHOLDER_SUMMARY",  cfg_get("placeholders","summary","No live event scheduled"))

# ---------- watch graph ----------
WATCH_API_BASE        = env("WATCH_API_BASE",        cfg_get("watch","api_base","https://watch.graph.api.espn.com/api"))
WATCH_API_KEY         = env("WATCH_API_KEY",         cfg_get("watch","api_key","0dbf88e8-cc6d-41da-aa83-18b5c630bc5c"))
...
WATCH_VERIFY_SSL      = env("WATCH_API_VERIFY_SSL",  cfg_get("watch","verify_ssl","1"), cast=bool)
